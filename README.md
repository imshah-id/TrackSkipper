...
- **Scrolling:** playback keeps surrounding lines steady until the caret approaches a visible edge, adapting to the editor height. Manual scrolling holds your chosen view until **Follow playback**.
